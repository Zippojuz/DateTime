...
from game import data, house, inventory, preferences, social, university
...
def research(save_id, player, clock, subject, day):
    ...
    reveal = undiscovered[
        : 1
        + university.bonus(player, "research_topics_bonus")
        + house.bonus(player, "research_topics_bonus")
    ]
